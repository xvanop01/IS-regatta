...
/**
 * CrewView
 * Neperzistovana entita zdruzujuca informacie pre CrewTableDataService
...
@Subselect("SELECT crew.id, "
        ...
        + "  IFNULL(owner.full_name, owner.username) as ship_owner_name, " // pouzije username, ak nema ulozene civilne meno
